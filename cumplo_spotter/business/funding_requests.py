...
from cumplo_spotter.models.filter import (
    ...
    BorrowerMinimumAmountRequestedFilter,
    BorrowerMinimumCreditsRequestedFilter,
    BorrowerMinimumPaidInTimeFilter,
    CreditTypeFilter,
    DebtorDicomFilter,
    DebtorMinimumCreditsRequestedFilter,
...
def filter_(funding_requests: list[FundingRequest], configuration: FilterConfiguration) -> list[FundingRequest]:
    ...
    filters = [
        ...
        BorrowerMinimumAmountRequestedFilter(configuration),
        BorrowerMinimumCreditsRequestedFilter(configuration),
        BorrowerMaximumAverageDaysDelinquentFilter(configuration),
        DebtorMinimumCreditsRequestedFilter(configuration),
